...
impl Ticket {
    ...
    fn handle_description(description: &String) {
    ...
    fn handle_status(status: &String) {
    ...
    pub fn set_title(&mut self, new_title: String) {
        self::Ticket::handle_title(&new_title);
        self.title = new_title;
    }
    pub fn set_description(&mut self, new_description: String) {
        self::Ticket::handle_description(&new_description);

        self.description = new_description;
    }
    pub fn set_status(&mut self, new_status: String) {
        self::Ticket::handle_status(&new_status);
